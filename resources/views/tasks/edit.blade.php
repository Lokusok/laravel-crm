                    ...
                    <form action="{{ route('tasks.update', $task) }}" method="POST">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="deadline_at" class="block mt-1 w-full" type="date" name="deadline_at"
                                :value="old('deadline_at', $task->deadline_at->format('Y-m-d'))" required autofocus autocomplete="deadline_at" />
                        ...
                        <div class="mt-4">
                            ...
                            <select id="project_id" name="project_id" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
