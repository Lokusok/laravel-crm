                    ...
                    <form action="{{ route('clients.update', $client) }}" method="POST">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="contact_email" class="block mt-1 w-full" type="text" name="contact_email"
                                :value="old('contact_email', $client->contact_email)" required autofocus autocomplete="contact_email" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="contact_phone_number" class="block mt-1 w-full" type="text" name="contact_phone_number"
                                :value="old('contact_phone_number', $client->contact_phone_number)" required autofocus autocomplete="contact_phone_number" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="company_name" class="block mt-1 w-full" type="text" name="company_name"
                                :value="old('company_name', $client->company_name)" required autofocus autocomplete="company_name" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="company_address" class="block mt-1 w-full" type="text" name="company_address"
                                :value="old('company_address', $client->company_address)" required autofocus autocomplete="company_address" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="company_city" class="block mt-1 w-full" type="text" name="company_city"
                                :value="old('company_city', $client->company_city)" required autofocus autocomplete="company_city" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="company_zip" class="block mt-1 w-full" type="text" name="company_zip"
                                :value="old('company_zip', $client->company_zip)" required autofocus autocomplete="company_zip" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="company_vat" class="block mt-1 w-full" type="text" name="company_vat"
                                :value="old('company_vat', $client->company_vat)" required autofocus autocomplete="company_vat" />
